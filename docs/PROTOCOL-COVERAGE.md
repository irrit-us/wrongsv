...
1. ~~VLESS WebSocket TCP/raw UDP/Mux.Cool XUDP, packetaddr UDP, and HTTPUpgrade TCP/UDP carrier coverage~~ → **Done**. gRPC/XHTTP carriers still open.
2. QUIC/KCP/WebTransport carrier modes.
3. VMess, TUIC, ShadowTLS.
