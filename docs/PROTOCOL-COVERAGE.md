...
4. Real-client Trojan and Shadowsocks 2022 lifecycle coverage.
5. SoftEther/OpenVPN/SSTP only if the project scope expands from proxy relay to VPN tunneling.
